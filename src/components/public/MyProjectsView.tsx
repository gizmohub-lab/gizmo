  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-10">
          ...
          filteredProjects.map((project) => (
            ...
            >
              ...
              <div className="flex flex-wrap items-center gap-2.5 shrink-0 self-stretch md:self-auto justify-end pt-4 md:pt-0 border-t md:border-t-0 border-zinc-100">
                <a
                  href={`https://wa.me/919876543210?text=Hello%20Gizmo%20Design%2C%20status%20update%20request%20for%20project%20${encodeURIComponent(
                    project.title
                  )}%20(${project.id})`}
                  target="_blank"
      ...
      <div className="p-6 rounded-2xl bg-zinc-950 text-white flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <a
          href="https://wa.me/919876543210?text=Hello%20Gizmo%20Design%20Director%2C%20urgent%20inquiry"
          target="_blank"
          rel="noopener noreferrer"
