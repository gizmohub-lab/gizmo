      ...
      <div className="p-8 rounded-3xl bg-zinc-50 border border-zinc-200 flex flex-col md:flex-row items-center justify-between gap-6">
        <div className="space-y-2 text-center md:text-left">
          ...
          <p className="text-xs text-zinc-500">
            Official Email: <span className="font-mono text-zinc-700">gizmo.hub.in@gmail.com</span> | Phone / WhatsApp: <span className="font-mono text-zinc-700">+91 98765 43210</span>
          </p>
        </div>

        <div className="flex items-center gap-3">
          <a
            href="https://wa.me/919876543210?text=Hello%20Gizmo%20Design%2C%20I%20would%20like%20to%20visit%20or%20inquire"
            target="_blank"
